...
![Histogram Viewer Dashboard.png](https://github.com/roannelafuente/WAT-Data-Automation-v1.0.0/blob/main/Histogram%20Viewer%20Dashboard.png)
- **Sample Output Capability Plot (Param G)**
![Sample Histogram Plot.png](https://github.com/roannelafuente/WAT-Data-Automation-v1.0.0/blob/main/Param_G.png)
